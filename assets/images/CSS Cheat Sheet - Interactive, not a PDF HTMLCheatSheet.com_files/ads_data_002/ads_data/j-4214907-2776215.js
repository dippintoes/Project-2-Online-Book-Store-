//Generated:2020-07-15 21:57:58// 6-239
(function(){
    var o = {
    $: function(el) {
        var x = el || o.divID, p = {
    ...
    (function() {
    var p = "4214907", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_4214907||'',
    guid:window.ftGUID_4214907||'',
    confID:window.ftConfID_4214907||'0',
    ftReturn: window.ftReturn_4214907||'',
    keyword:window.ftKeyword_4214907||'',
    ftId:window.ftId_4214907||'',
    ftImpId:window.ftImp4214907 && window.ftImp4214907.impID || '',
    campaignID: '115843',
    cID:'100966',
    pID:'4214907',
    creativeID:'2776215',
    exttrack:[],
    extscript:["https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115843&sid=18330&plc=4214907&num=&adid=&advid=&adsrv=29&btreg=4214907&btadsrv=flashtalking&crt=2776215&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"],
    clickTags: ['http://servedby.flashtalking.com/click/8/115843;4214907;2776215;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/in/creativecloud/plans.html?plan=individual&sdid=GZKZY1B7&mv=display'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?184123101-4214907;2776215;',
    centreAd: false,
    width:300,
    height:250,
    adType:'custom_rule'.toLowerCase(),
    altimg:'http://cdn.flashtalking.com/xre/421/4214907/2776215/image/2776215.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/115843;4214907;202;pixel;DV360;DV360FY20CCBEHInMarketINDSKBAN300x250/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref:'http://servedby.flashtalking.com/click/8/115843;4214907;2776215;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/in/creativecloud/plans.html?plan=individual&sdid=GZKZY1B7&mv=display',
    divID:'ftdiv4214907',
    altimgID:'ftalt4214907',
    alttext:'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4214907 && parseInt(window.ftImp4214907.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4214907') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m4214907'),
    pageVisible: 'maybe',
